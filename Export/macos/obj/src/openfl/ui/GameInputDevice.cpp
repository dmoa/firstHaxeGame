...
HXDLIN(  72)			while((_g < (int)6)){
HXLINE(  72)				_g = (_g + (int)1);
HXDLIN(  72)				int i = (_g - (int)1);
HXLINE(  74)				control =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),(HX_("AXIS_",9e,28,6e,a7) + i),(int)-1,(int)1,null());
HXLINE(  75)				this->_hx___axis->set(i,control);
HXLINE(  76)				this->_hx___controls->push(control);
            			}
            		}
HXLINE(  79)		{
HXLINE(  79)			int _g1 = (int)0;
HXDLIN(  79)			while((_g1 < (int)15)){
HXLINE(  79)				_g1 = (_g1 + (int)1);
HXDLIN(  79)				int i1 = (_g1 - (int)1);
HXLINE(  81)				control =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),(HX_("BUTTON_",2d,26,49,4a) + i1),(int)0,(int)1,null());
HXLINE(  82)				this->_hx___button->set(i1,control);
