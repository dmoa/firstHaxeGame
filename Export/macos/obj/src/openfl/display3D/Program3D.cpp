...
HXLINE( 397)		if ((::lime::utils::Log_obj::level == (int)5)) {
HXLINE( 399)			::lime::utils::Log_obj::info(glslVertex,hx::SourceInfo(HX_("Program3D.hx",c9,bd,cd,87),399,HX_("openfl.display3D.Program3D",7c,83,68,f5),HX_("upload",01,ca,59,8c)));
HXLINE( 400)			::lime::utils::Log_obj::info(glslFragment,hx::SourceInfo(HX_("Program3D.hx",c9,bd,cd,87),400,HX_("openfl.display3D.Program3D",7c,83,68,f5),HX_("upload",01,ca,59,8c)));
            		}
...
HXLINE( 409)				::Array< ::Dynamic> _hx_tmp = this->_hx___samplerStates;
HXDLIN( 409)				_hx_tmp[i] = samplerStates->__get(i).StaticCast<  ::openfl::_internal::renderer::SamplerState >();
            			}
            		}
            	}
...
HXLINE( 575)				if ((::lime::utils::Log_obj::level == (int)5)) {
HXLINE( 577)					::lime::utils::Log_obj::verbose((((((((((HX_("",00,00,00,00) + i) + HX_(" name:",6f,1b,f0,61)) + uniform->name) + HX_(" type:",20,fc,36,e6)) + uniform->type) + HX_(" size:",39,94,44,48)) + uniform->size) + HX_(" location:",45,fc,a8,c1)) + uniform->location),hx::SourceInfo(HX_("Program3D.hx",c9,bd,cd,87),577,HX_("openfl.display3D.Program3D",7c,83,68,f5),HX_("__buildAGALUniformList",93,6f,2b,39)));
            				}
            			}
            		}
