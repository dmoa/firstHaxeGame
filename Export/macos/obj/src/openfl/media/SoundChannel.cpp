...
HXDLIN( 146)		return (_hx_tmp + this->_hx___source->offset);
            	}
...
HXLINE( 176)			if ((pan < (int)-1)) {
HXLINE( 176)				pan = (int)-1;
            			}
HXLINE( 177)			if ((pan > (int)1)) {
HXLINE( 177)				pan = (int)1;
            			}
...
HXLINE( 188)				position->z = ((int)-1 * ::Math_obj::sqrt(((int)1 - ::Math_obj::pow(pan,(int)2))));
