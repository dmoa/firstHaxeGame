...
HXLINE( 194)								 ::cpp::vm::Deque _hx_tmp3 = this->_hx___workIncoming;
HXDLIN( 194)								_hx_tmp3->add( ::lime::_hx_system::_ThreadPool::ThreadPoolMessage_obj::__alloc( HX_CTX ,::lime::_hx_system::_ThreadPool::ThreadPoolMessageType_obj::EXIT_dyn(),null()));
            							}
...
HXLINE( 216)				_hx_tmp5 = (this->minThreads <= (int)0);
            			}
            			else {
HXLINE( 216)				_hx_tmp5 = false;
            			}
HXDLIN( 216)			if (_hx_tmp5) {
HXLINE( 216)				_hx_tmp4 = hx::IsNotNull( ::lime::app::Application_obj::current );
            			}
            			else {
