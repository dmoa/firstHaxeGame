...
HXLINE(1284)		::lime::_internal::backend::native::NativeCFFI_obj::lime_al_source_queue_buffers(hx::DynamicPtr(source),(int)1,hx::DynamicPtr(buffers));
            	}
...
HXLINE(1304)		 ::hx::Object * res = ::lime::_internal::backend::native::NativeCFFI_obj::lime_al_source_unqueue_buffers(hx::DynamicPtr(source),(int)1);
HXLINE(1305)		return ( ( ::Dynamic)(res) )->__GetItem((int)0);
            	}
...
HXDLIN(1332)		::lime::_internal::backend::native::NativeCFFI_obj::lime_al_speed_of_sound(value);
            	}
