...
HXLINE(  58)		::String data;
HXDLIN(  58)		 ::lime::utils::AssetManifest manifest;
HXDLIN(  58)		 ::lime::utils::AssetLibrary library;
HXLINE(  71)		data = HX_("{\"name\":null,\"assets\":\"ah\",\"rootPath\":null,\"version\":2,\"libraryArgs\":[],\"libraryType\":null}",6c,e1,75,d6);
HXLINE(  72)		manifest = ::lime::utils::AssetManifest_obj::parse(data,::ManifestResources_obj::rootPath);
HXLINE(  73)		library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
