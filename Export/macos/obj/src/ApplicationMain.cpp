...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("SampleProject",af,e3,34,d8),::ApplicationMain_obj::create_dyn());
...
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("SampleProject",af,e3,34,d8));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("SampleProject",af,e3,34,d8));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.sample.sampleproject",f8,c9,c4,c9));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),(int)512)
            			...
            			->setFixed(7,HX_("height",e7,07,4c,02),(int)512)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("SampleProject",af,e3,34,d8))
            			...
            			->setFixed(13,HX_("frameRate",ad,11,25,39),(int)30)
...
HXLINE(  66)		attributes->__SetField(HX_("context",ef,95,77,19), ::Dynamic(hx::Anon_obj::Create(8)
            			...
            			->setFixed(3,HX_("background",ee,93,1d,26),(int)16777215)
...
HXLINE( 187)			{
HXLINE( 188)				 ::openfl::display::DisplayObject current = stage->getChildAt((int)0);
